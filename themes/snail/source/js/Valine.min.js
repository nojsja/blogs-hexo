...
(function() {
	/* 发送评论到微信 */
	window.sendMsgToWechat = function(msg) {
		var xhr = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
		xhr.onreadystatechange = function () {
				if (xhr.readyState == 4 && xhr.status == 200) {
						console.log('sendToWechat -> ', xhr.responseText);
				} else {
						console.log('sendToWechat -> ', false);
				}
		}
		xhr.onerror = function(e){
				console.log(e)
		}
		xhr.open('GET','https://push.bot.qw360.cn/send/cf6829d0-e9d8-11eb-bcea-e767e07f0bdc?msg=' + msg, true);
		xhr.send(null);
	};
})();
